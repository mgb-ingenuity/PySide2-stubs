...
class QXmlQuery(Shiboken.Object):
    ...
    @typing.overload
    def bindVariable(
        self, localName: str, arg__2: PySide2.QtCore.QIODevice
    ) -> None: ...
    @typing.overload
    def bindVariable(
    ...
    @typing.overload
    def evaluateTo(
        self, callback: PySide2.QtXmlPatterns.QAbstractXmlReceiver
    ) -> bool: ...
    @typing.overload
    ...
    @typing.overload
    def setQuery(
        self, sourceCode: str, documentURI: PySide2.QtCore.QUrl = ...
    ) -> None: ...
    def setUriResolver(
