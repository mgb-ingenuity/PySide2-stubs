...
class QJSEngine(PySide2.QtCore.QObject):
    ...
    class Extensions(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, Extension, Extensions] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, Extension, Extensions]
        ) -> Extensions: ...
        def __and__(
            self, other: typing.Union[int, Extension, Extensions]
        ) -> Extensions: ...
    ...
    def installTranslatorFunctions(
        self, object: PySide2.QtQml.QJSValue = ...
    ) -> None: ...
...
class QQmlComponent(PySide2.QtCore.QObject):
    ...
    def beginCreate(
        self, arg__1: PySide2.QtQml.QQmlContext
...
class QQmlContext(PySide2.QtCore.QObject):
    ...
    def setContextProperty(
        self, arg__1: str, arg__2: PySide2.QtCore.QObject
    ) -> None: ...
    @typing.overload
...
class QQmlDebuggingEnabler(Shiboken.Object):
    ...
    def startDebugConnector(
        pluginName: str, configuration: typing.Dict = ...
    ) -> bool: ...
    @staticmethod
...
class QQmlEngine(PySide2.QtQml.QJSEngine):
    ...
    def importPlugin(
        self, filePath: str, uri: str, errors: typing.Sequence
    ) -> bool: ...
...
class QQmlExpression(PySide2.QtCore.QObject):
    ...
    def setSourceLocation(
        self, fileName: str, line: int, column: int = ...
    ) -> None: ...
...
class QQmlExtensionInterface(PySide2.QtQml.QQmlTypesExtensionInterface):
    ...
    def initializeEngine(
        self, engine: PySide2.QtQml.QQmlEngine, uri: bytes
    ) -> None: ...
...
class QQmlProperty(Shiboken.Object):
    ...
    def connectNotifySignal(
        self, dest: PySide2.QtCore.QObject, method: int
    ) -> bool: ...
    @typing.overload
    def connectNotifySignal(
        self, dest: PySide2.QtCore.QObject, slot: bytes
    ) -> bool: ...
    ...
    @staticmethod
    def write(
        arg__1: PySide2.QtCore.QObject, arg__2: str, arg__3: typing.Any
    ) -> bool: ...
    @typing.overload
    @staticmethod
    def write(
