...
class QGeoAreaMonitorSource(PySide2.QtCore.QObject):
    ...
    class AreaMonitorFeature(object):
        ...
        def __init__(
            self, value: typing.Union[int, AreaMonitorFeature] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, AreaMonitorFeature]
        ) -> AreaMonitorFeatures: ...
        def __and__(
            self, other: typing.Union[int, AreaMonitorFeature]
        ) -> AreaMonitorFeatures: ...
    ...
    class AreaMonitorFeatures(object):
        ...
        def __init__(
            self,
            value: typing.Union[int, AreaMonitorFeature, AreaMonitorFeatures] = ...,
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, AreaMonitorFeature, AreaMonitorFeatures]
        ) -> AreaMonitorFeatures: ...
        def __and__(
            self, other: typing.Union[int, AreaMonitorFeature, AreaMonitorFeatures]
        ) -> AreaMonitorFeatures: ...
...
class QGeoPositionInfoSource(PySide2.QtCore.QObject):
    ...
    class PositioningMethod(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, PositioningMethod] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, PositioningMethod]
        ) -> PositioningMethods: ...
        def __and__(
            self, other: typing.Union[int, PositioningMethod]
        ) -> PositioningMethods: ...
    ...
    class PositioningMethods(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, PositioningMethod, PositioningMethods] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, PositioningMethod, PositioningMethods]
        ) -> PositioningMethods: ...
        def __and__(
            self, other: typing.Union[int, PositioningMethod, PositioningMethods]
        ) -> PositioningMethods: ...
...
class QGeoRectangle(PySide2.QtPositioning.QGeoShape):
    ...
    def setBottomLeft(
        self, bottomLeft: PySide2.QtPositioning.QGeoCoordinate
    ) -> None: ...
    def setBottomRight(
        self, bottomRight: PySide2.QtPositioning.QGeoCoordinate
    ) -> None: ...
    def setCenter(self, center: PySide2.QtPositioning.QGeoCoordinate) -> None: ...
