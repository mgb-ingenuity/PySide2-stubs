...
class QGLBuffer(Shiboken.Object):
    ...
    def setUsagePattern(
        self, value: PySide2.QtOpenGL.QGLBuffer.UsagePattern
    ) -> None: ...
    def size(self) -> int: ...
...
class QGLContext(Shiboken.Object):
    ...
    class BindOptions(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, BindOption, BindOptions] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, BindOption, BindOptions]
        ) -> BindOptions: ...
        def __and__(
            self, other: typing.Union[int, BindOption, BindOptions]
        ) -> BindOptions: ...
...
class QGLFormat(Shiboken.Object):
    ...
    class OpenGLVersionFlag(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, OpenGLVersionFlag] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, OpenGLVersionFlag]
        ) -> OpenGLVersionFlags: ...
        def __and__(
            self, other: typing.Union[int, OpenGLVersionFlag]
        ) -> OpenGLVersionFlags: ...
    ...
    class OpenGLVersionFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags]
        ) -> OpenGLVersionFlags: ...
        def __and__(
            self, other: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags]
        ) -> OpenGLVersionFlags: ...
