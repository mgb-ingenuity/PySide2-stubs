...
class QAccessible(Shiboken.Object):
    ...
    class Relation(object):
        ...
        def __init__(
            self, value: typing.Union[int, RelationFlag, Relation] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, RelationFlag, Relation]
        ) -> Relation: ...
        def __and__(
            self, other: typing.Union[int, RelationFlag, Relation]
        ) -> Relation: ...
    ...
    @staticmethod
    def registerAccessibleInterface(
...
class QAccessibleInterface(Shiboken.Object):
    ...
    def interface_cast(
        self, arg__1: PySide2.QtGui.QAccessible.InterfaceType
    ) -> int: ...
    ...
    def relations(
        self, match: PySide2.QtGui.QAccessible.Relation = ...
    ) -> typing.List: ...
...
class QAccessibleTextInsertEvent(PySide2.QtGui.QAccessibleTextCursorEvent):
    ...
    @typing.overload
    def __init__(
        self, obj: PySide2.QtCore.QObject, position: int, text: str
    ) -> None: ...
...
class QBrush(Shiboken.Object):
    ...
    def swap(
        self, other: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor]
    ) -> None: ...
...
class QClipboard(PySide2.QtCore.QObject):
    ...
    def setText(
        self, arg__1: str, mode: PySide2.QtGui.QClipboard.Mode = ...
    ) -> None: ...
...
class QColor(Shiboken.Object):
    ...
    def __init__(
        self,
        spec: PySide2.QtGui.QColor.Spec,
        a1: int,
        a2: int,
        a3: int,
        a4: int,
    ...
    def convertTo(
        self, colorSpec: PySide2.QtGui.QColor.Spec
    ...
    def setCmykF(
        self, c: float, m: float, y: float, k: float, a: float = ...
    ) -> None: ...
...
class QColorSpace(Shiboken.Object):
    ...
    @typing.overload
    def setPrimaries(
        self, primariesId: PySide2.QtGui.QColorSpace.Primaries
    ) -> None: ...
    @typing.overload
    def setPrimaries(
        self,
...
class QCursor(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, cursor: Union[PySide2.QtGui.QCursor, PySide2.QtCore.Qt.CursorShape]
    ) -> None: ...
    @typing.overload
    def __init__(
    ...
    def __rshift__(
        self, inS: PySide2.QtCore.QDataStream
    ) -> PySide2.QtCore.QDataStream: ...
    ...
    def swap(
        self, other: Union[PySide2.QtGui.QCursor, PySide2.QtCore.Qt.CursorShape]
    ) -> None: ...
...
class QDrag(PySide2.QtCore.QObject):
    ...
    def dragCursor(
        self, action: PySide2.QtCore.Qt.DropAction
    ) -> PySide2.QtGui.QPixmap: ...
    @typing.overload
    def exec_(
        self,
...
class QFontDatabase(Shiboken.Object):
    ...
    @staticmethod
    def systemFont(
        type: PySide2.QtGui.QFontDatabase.SystemFont,
    ) -> PySide2.QtGui.QFont: ...
...
class QGradient(Shiboken.Object):
    ...
    def setCoordinateMode(
        self, mode: PySide2.QtGui.QGradient.CoordinateMode
    ) -> None: ...
...
class QGuiApplication(PySide2.QtCore.QCoreApplication):
    ...
    def changeOverrideCursor(
        arg__1: Union[PySide2.QtGui.QCursor, PySide2.QtCore.Qt.CursorShape]
    ) -> None: ...
    @staticmethod
    ...
    def highDpiScaleFactorRoundingPolicy() -> (
        PySide2.QtCore.Qt.HighDpiScaleFactorRoundingPolicy
    ): ...
    @staticmethod
...
class QImage(PySide2.QtGui.QPaintDevice):
    ...
    def setPixelColor(
        ...
        c: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
    ) -> None: ...
    @typing.overload
    def setPixelColor(
        self,
...
class QImageIOHandler(Shiboken.Object):
    ...
    class Transformation(object):
        ...
        def __or__(
            self, other: typing.Union[int, Transformation]
        ) -> Transformations: ...
        def __and__(
            self, other: typing.Union[int, Transformation]
        ) -> Transformations: ...
    ...
    class Transformations(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, Transformation, Transformations] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, Transformation, Transformations]
        ) -> Transformations: ...
        def __and__(
            self, other: typing.Union[int, Transformation, Transformations]
        ) -> Transformations: ...
    ...
    def option(
        self, option: PySide2.QtGui.QImageIOHandler.ImageOption
    ) -> typing.Any: ...
...
class QImageReader(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, fileName: str, format: PySide2.QtCore.QByteArray = ...
    ) -> None: ...
...
class QKeySequence(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, k1: int, k2: int = ..., k3: int = ..., k4: int = ...
    ) -> None: ...
    @typing.overload
    ...
    def __copy__() -> None: ...
    def __lshift__(
        self, in_: PySide2.QtCore.QDataStream
    ) -> PySide2.QtCore.QDataStream: ...
    def __reduce__(self) -> object: ...
    def __repr__(self) -> object: ...
    def __rshift__(
        self, out: PySide2.QtCore.QDataStream
    ) -> PySide2.QtCore.QDataStream: ...
    def count(self) -> int: ...
    @staticmethod
    def fromString(
    ...
    def toString(
        self, format: PySide2.QtGui.QKeySequence.SequenceFormat = ...
    ) -> str: ...
...
class QOffscreenSurface(PySide2.QtCore.QObject, PySide2.QtGui.QSurface):
    ...
    @typing.overload
    def __init__(
        self, screen: typing.Optional[PySide2.QtGui.QScreen] = ...
    ) -> None: ...
...
class QOpenGLBuffer(Shiboken.Object):
    ...
    class RangeAccessFlag(object):
        ...
        def __or__(
            self, other: typing.Union[int, RangeAccessFlag]
        ) -> RangeAccessFlags: ...
        def __and__(
            self, other: typing.Union[int, RangeAccessFlag]
        ) -> RangeAccessFlags: ...
    ...
    class RangeAccessFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, RangeAccessFlag, RangeAccessFlags] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, RangeAccessFlag, RangeAccessFlags]
        ) -> RangeAccessFlags: ...
        def __and__(
            self, other: typing.Union[int, RangeAccessFlag, RangeAccessFlags]
        ) -> RangeAccessFlags: ...
    ...
    def setUsagePattern(
        self, value: PySide2.QtGui.QOpenGLBuffer.UsagePattern
    ) -> None: ...
    def size(self) -> int: ...
...
class QOpenGLDebugMessage(Shiboken.Object):
    ...
    class Severities(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, Severity, Severities] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, Severity, Severities]
        ) -> Severities: ...
        def __and__(
            self, other: typing.Union[int, Severity, Severities]
        ) -> Severities: ...
...
class QOpenGLExtraFunctions(PySide2.QtGui.QOpenGLFunctions):
    ...
    def glGetIntegeri_v(
        self, target: int, index: int, data: typing.Sequence
    ) -> None: ...
    ...
    def glGetMultisamplefv(
        self, pname: int, index: int, val: typing.Sequence
    ) -> None: ...
    ...
    def glGetQueryObjectuiv(
        self, id: int, pname: int, params: typing.Sequence
    ) -> None: ...
    def glGetQueryiv(
        self, target: int, pname: int, params: typing.Sequence
    ) -> None: ...
    ...
    def glUniform1uiv(
        self, location: int, count: int, value: typing.Sequence
    ) -> None: ...
...
class QOpenGLFunctions(Shiboken.Object):
    ...
    class OpenGLFeature(object):
        ...
        def __and__(
            self, other: typing.Union[int, OpenGLFeature]
        ) -> OpenGLFeatures: ...
        def __xor__(
            self, other: typing.Union[int, OpenGLFeature]
        ) -> OpenGLFeatures: ...
    ...
    class OpenGLFeatures(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, OpenGLFeature, OpenGLFeatures] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, OpenGLFeature, OpenGLFeatures]
        ) -> OpenGLFeatures: ...
        def __and__(
            self, other: typing.Union[int, OpenGLFeature, OpenGLFeatures]
        ) -> OpenGLFeatures: ...
    ...
    def glDrawElements(
        self, mode: int, count: int, type: int, indices: int
    ) -> None: ...
    ...
    def glGetProgramiv(
        self, program: int, pname: int, params: typing.Sequence
    ) -> None: ...
    ...
    def glGetShaderiv(
        self, shader: int, pname: int, params: typing.Sequence
    ) -> None: ...
    ...
    def glStencilOpSeparate(
        self, face: int, fail: int, zfail: int, zpass: int
    ) -> None: ...
    def glTexImage2D(
        self,
        target: int,
...
class QOpenGLShader(PySide2.QtCore.QObject):
    ...
    class ShaderType(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ShaderTypeBit, ShaderType] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ShaderTypeBit, ShaderType]
        ) -> ShaderType: ...
        def __and__(
            self, other: typing.Union[int, ShaderTypeBit, ShaderType]
        ) -> ShaderType: ...
...
class QOpenGLShaderProgram(PySide2.QtCore.QObject):
    ...
    def setAttributeValue(
        self,
        location: int,
        value: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
    ) -> None: ...
    @typing.overload
    def setAttributeValue(
        self, location: int, value: PySide2.QtGui.QVector2D
    ) -> None: ...
    @typing.overload
    def setAttributeValue(
        self, location: int, value: PySide2.QtGui.QVector3D
    ) -> None: ...
    @typing.overload
    def setAttributeValue(
        self, location: int, value: PySide2.QtGui.QVector4D
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setAttributeValue(
        self, name: bytes, value: PySide2.QtGui.QVector2D
    ) -> None: ...
    @typing.overload
    def setAttributeValue(
        self, name: bytes, value: PySide2.QtGui.QVector3D
    ) -> None: ...
    @typing.overload
    def setAttributeValue(
        self, name: bytes, value: PySide2.QtGui.QVector4D
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setUniformValue(
        self, location: int, value: PySide2.QtGui.QMatrix2x2
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, location: int, value: PySide2.QtGui.QMatrix2x3
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, location: int, value: PySide2.QtGui.QMatrix2x4
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, location: int, value: PySide2.QtGui.QMatrix3x2
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, location: int, value: PySide2.QtGui.QMatrix3x3
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, location: int, value: PySide2.QtGui.QMatrix3x4
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, location: int, value: PySide2.QtGui.QMatrix4x2
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, location: int, value: PySide2.QtGui.QMatrix4x3
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, location: int, value: PySide2.QtGui.QMatrix4x4
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, location: int, value: PySide2.QtGui.QTransform
    ) -> None: ...
    @typing.overload
    def setUniformValue(
        self, location: int, value: PySide2.QtGui.QVector2D
...
class QOpenGLTexture(Shiboken.Object):
    ...
    class Features(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, Feature, Features] = ...
        ) -> None: ...
...
class QPagedPaintDevice(PySide2.QtGui.QPaintDevice):
    ...
    class Margins(Shiboken.Object):
        ...
        @typing.overload
        def __init__(
            self, Margins: PySide2.QtGui.QPagedPaintDevice.Margins
        ) -> None: ...
        @staticmethod
        def __copy__() -> None: ...
...
class QPaintEngine(Shiboken.Object):
    ...
    class DirtyFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, DirtyFlag, DirtyFlags] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, DirtyFlag, DirtyFlags]
        ) -> DirtyFlags: ...
        def __and__(
            self, other: typing.Union[int, DirtyFlag, DirtyFlags]
        ) -> DirtyFlags: ...
    ...
    class PaintEngineFeature(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, PaintEngineFeature] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, PaintEngineFeature]
        ) -> PaintEngineFeatures: ...
        def __and__(
            self, other: typing.Union[int, PaintEngineFeature]
        ) -> PaintEngineFeatures: ...
    ...
    class PaintEngineFeatures(object):
        ...
        def __init__(
            self,
            value: typing.Union[int, PaintEngineFeature, PaintEngineFeatures] = ...,
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, PaintEngineFeature, PaintEngineFeatures]
        ) -> PaintEngineFeatures: ...
        def __and__(
            self, other: typing.Union[int, PaintEngineFeature, PaintEngineFeatures]
        ) -> PaintEngineFeatures: ...
...
class QPainter(Shiboken.Object):
    ...
    class PixmapFragmentHint(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, PixmapFragmentHint] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, PixmapFragmentHint]
        ) -> PixmapFragmentHints: ...
        def __and__(
            self, other: typing.Union[int, PixmapFragmentHint]
        ) -> PixmapFragmentHints: ...
    ...
    class PixmapFragmentHints(object):
        ...
        def __init__(
            self,
            value: typing.Union[int, PixmapFragmentHint, PixmapFragmentHints] = ...,
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, PixmapFragmentHint, PixmapFragmentHints]
        ) -> PixmapFragmentHints: ...
        def __and__(
            self, other: typing.Union[int, PixmapFragmentHint, PixmapFragmentHints]
        ) -> PixmapFragmentHints: ...
    ...
    class RenderHints(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, RenderHint, RenderHints] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, RenderHint, RenderHints]
        ) -> RenderHints: ...
        def __and__(
            self, other: typing.Union[int, RenderHint, RenderHints]
        ) -> RenderHints: ...
    ...
    def drawConvexPolygon(
        self, arg__1: typing.List[PySide2.QtCore.QPointF]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawEllipse(
        self, center: PySide2.QtCore.QPointF, rx: float, ry: float
    ) -> None: ...
    @typing.overload
    def drawEllipse(self, r: PySide2.QtCore.QRect) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawImage(
        self, p: PySide2.QtCore.QPoint, image: PySide2.QtGui.QImage
    ) -> None: ...
    @typing.overload
    def drawImage(
        self,
    ...
    @typing.overload
    def drawImage(
        self, p: PySide2.QtCore.QPointF, image: PySide2.QtGui.QImage
    ) -> None: ...
    @typing.overload
    def drawImage(
        self,
    ...
    @typing.overload
    def drawImage(
        self, r: PySide2.QtCore.QRect, image: PySide2.QtGui.QImage
    ) -> None: ...
    @typing.overload
    def drawImage(
        self, r: PySide2.QtCore.QRectF, image: PySide2.QtGui.QImage
    ) -> None: ...
    @typing.overload
    def drawImage(
        self,
    ...
    @typing.overload
    def drawPixmap(
        self, p: PySide2.QtCore.QPoint, pm: PySide2.QtGui.QPixmap
    ) -> None: ...
    @typing.overload
    def drawPixmap(
        self,
    ...
    @typing.overload
    def drawPixmap(
        self, p: PySide2.QtCore.QPointF, pm: PySide2.QtGui.QPixmap
    ) -> None: ...
    @typing.overload
    def drawPixmap(
        self,
    ...
    @typing.overload
    def drawPixmap(
        self, r: PySide2.QtCore.QRect, pm: PySide2.QtGui.QPixmap
    ) -> None: ...
    @typing.overload
    def drawPixmap(
        self,
    ...
    def drawPolygon(
        self,
        arg__1: typing.List[PySide2.QtCore.QPoint],
        arg__2: PySide2.QtCore.Qt.FillRule = ...,
    ) -> None: ...
    @typing.overload
    def drawPolygon(
        self,
        arg__1: typing.List[PySide2.QtCore.QPointF],
        arg__2: PySide2.QtCore.Qt.FillRule = ...,
    ) -> None: ...
    @typing.overload
    def drawPolygon(
    ...
    def fillPath(
        ...
        brush: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
    ) -> None: ...
    @typing.overload
    def fillRect(
        self,
        arg__1: PySide2.QtCore.QRect,
        arg__2: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
    ) -> None: ...
    @typing.overload
    def fillRect(
        self,
    ...
    def fillRect(
        ...
        w: int,
        h: int,
        arg__5: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
    ) -> None: ...
    @typing.overload
    def fillRect(
    ...
    def setBackground(
        self, bg: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor]
    ) -> None: ...
    def setBackgroundMode(self, mode: PySide2.QtCore.Qt.BGMode) -> None: ...
    @typing.overload
    def setBrush(
        self, brush: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor]
    ) -> None: ...
    @typing.overload
    ...
    def setCompositionMode(
        self, mode: PySide2.QtGui.QPainter.CompositionMode
    ) -> None: ...
...
class QPainterPath(Shiboken.Object):
    ...
    def __add__(
        self, other: PySide2.QtGui.QPainterPath
    ...
    @typing.overload
    def addRoundRect(
        self, rect: PySide2.QtCore.QRectF, xRnd: int, yRnd: int
    ) -> None: ...
    @typing.overload
    def addRoundRect(
    ...
    @typing.overload
    def addText(
        self, x: float, y: float, f: PySide2.QtGui.QFont, text: str
    ) -> None: ...
    ...
    @typing.overload
    def toFillPolygon(
        self, matrix: PySide2.QtGui.QMatrix
    ...
    def toFillPolygons(
        self, matrix: PySide2.QtGui.QMatrix
    ) -> typing.List[PySide2.QtGui.QPolygonF]: ...
    @typing.overload
    def toFillPolygons(
        self, matrix: PySide2.QtGui.QTransform = ...
    ) -> typing.List[PySide2.QtGui.QPolygonF]: ...
    ...
    @typing.overload
    def translated(
        self, offset: PySide2.QtCore.QPointF
    ) -> PySide2.QtGui.QPainterPath: ...
...
class QPalette(Shiboken.Object):
    ...
    def __init__(
        self,
        button: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        button: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
        window: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
    ) -> None: ...
    @typing.overload
    ...
    def __init__(
        self,
        windowText: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
        button: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
        light: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
        dark: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
        mid: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
        text: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
        bright_text: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
        base: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
        window: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor],
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        windowText: Union[
            PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int
        ],
        window: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
        light: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
        dark: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
        mid: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
        text: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
        base: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
    ) -> None: ...
    @staticmethod
    def __copy__() -> None: ...
    def __lshift__(
        self, ds: PySide2.QtCore.QDataStream
    ) -> PySide2.QtCore.QDataStream: ...
    def __rshift__(
        self, ds: PySide2.QtCore.QDataStream
    ) -> PySide2.QtCore.QDataStream: ...
...
class QPdfWriter(PySide2.QtCore.QObject, PySide2.QtGui.QPagedPaintDevice):
    ...
    def setDocumentXmpMetadata(
        self, xmpMetadata: PySide2.QtCore.QByteArray
    ) -> None: ...
...
class QPictureIO(Shiboken.Object):
    ...
    @staticmethod
    def pictureFormat(
        arg__1: PySide2.QtCore.QIODevice,
...
class QPixmap(PySide2.QtGui.QPaintDevice):
    ...
    def createMaskFromColor(
        self,
        maskColor: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
        mode: PySide2.QtCore.Qt.MaskMode = ...,
    ) -> PySide2.QtGui.QBitmap: ...
    @staticmethod
    ...
    @typing.overload
    def fill(
        self, device: PySide2.QtGui.QPaintDevice, xofs: int, yofs: int
    ) -> None: ...
    @typing.overload
    def fill(
        self,
    ...
    @staticmethod
    def trueMatrix(
        m: PySide2.QtGui.QMatrix, w: int, h: int
    ) -> PySide2.QtGui.QMatrix: ...
    @typing.overload
    @staticmethod
    def trueMatrix(
...
class QPolygon(Shiboken.Object):
    ...
    def __add__(
        self, l: typing.List[PySide2.QtCore.QPoint]
    ) -> typing.List[PySide2.QtCore.QPoint]: ...
    @staticmethod
    def __copy__() -> None: ...
...
class QQuaternion(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, scalar: float, xpos: float, ypos: float, zpos: float
    ) -> None: ...
    @typing.overload
    ...
    def rotatedVector(
        self, vector: PySide2.QtGui.QVector3D
...
class QRasterWindow(PySide2.QtGui.QPaintDeviceWindow):
    def __init__(
        self, parent: typing.Optional[PySide2.QtGui.QWindow] = ...
    ) -> None: ...
    def metric(self, metric: PySide2.QtGui.QPaintDevice.PaintDeviceMetric) -> int: ...
    def redirected(
        self, arg__1: PySide2.QtCore.QPoint
...
class QRawFont(Shiboken.Object):
    ...
    class LayoutFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, LayoutFlag, LayoutFlags] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, LayoutFlag, LayoutFlags]
        ) -> LayoutFlags: ...
        def __and__(
            self, other: typing.Union[int, LayoutFlag, LayoutFlags]
        ) -> LayoutFlags: ...
...
class QScreen(PySide2.QtCore.QObject):
    ...
    def virtualSiblingAt(
        self, point: PySide2.QtCore.QPoint
...
class QSessionManager(PySide2.QtCore.QObject):
    ...
    def setRestartHint(
        self, arg__1: PySide2.QtGui.QSessionManager.RestartHint
    ) -> None: ...
...
class QSurfaceFormat(Shiboken.Object):
    ...
    class FormatOptions(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, FormatOption, FormatOptions] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, FormatOption, FormatOptions]
        ) -> FormatOptions: ...
        def __and__(
            self, other: typing.Union[int, FormatOption, FormatOptions]
        ) -> FormatOptions: ...
    ...
    def setOptions(
        self, options: PySide2.QtGui.QSurfaceFormat.FormatOptions
    ) -> None: ...
    def setProfile(
        self, profile: PySide2.QtGui.QSurfaceFormat.OpenGLContextProfile
    ) -> None: ...
...
class QSyntaxHighlighter(PySide2.QtCore.QObject):
    ...
    def setCurrentBlockUserData(
        self, data: PySide2.QtGui.QTextBlockUserData
    ) -> None: ...
...
class QTextCharFormat(PySide2.QtGui.QTextFormat):
    ...
    def setFontStyleStrategy(
        self, strategy: PySide2.QtGui.QFont.StyleStrategy
    ) -> None: ...
...
class QTextDocument(PySide2.QtCore.QObject):
    ...
    class MarkdownFeature(object):
        ...
        def __or__(
            self, other: typing.Union[int, MarkdownFeature]
        ) -> MarkdownFeatures: ...
        def __and__(
            self, other: typing.Union[int, MarkdownFeature]
        ) -> MarkdownFeatures: ...
    ...
    class MarkdownFeatures(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, MarkdownFeature, MarkdownFeatures] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, MarkdownFeature, MarkdownFeatures]
        ) -> MarkdownFeatures: ...
        def __and__(
            self, other: typing.Union[int, MarkdownFeature, MarkdownFeatures]
        ) -> MarkdownFeatures: ...
    ...
    def createObject(
        self, f: PySide2.QtGui.QTextFormat
    ...
    def metaInformation(
        self, info: PySide2.QtGui.QTextDocument.MetaInformation
    ) -> str: ...
...
class QTextFormat(Shiboken.Object):
    ...
    class PageBreakFlag(object):
        ...
        def __and__(
            self, other: typing.Union[int, PageBreakFlag]
        ) -> PageBreakFlags: ...
        def __xor__(
            self, other: typing.Union[int, PageBreakFlag]
        ) -> PageBreakFlags: ...
    ...
    class PageBreakFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, PageBreakFlag, PageBreakFlags] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, PageBreakFlag, PageBreakFlags]
        ) -> PageBreakFlags: ...
        def __and__(
            self, other: typing.Union[int, PageBreakFlag, PageBreakFlags]
        ) -> PageBreakFlags: ...
...
class QTextItem(Shiboken.Object):
    ...
    class RenderFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, RenderFlag, RenderFlags] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, RenderFlag, RenderFlags]
        ) -> RenderFlags: ...
        def __and__(
            self, other: typing.Union[int, RenderFlag, RenderFlags]
        ) -> RenderFlags: ...
...
class QTextLayout(Shiboken.Object):
    ...
    class FormatRange(Shiboken.Object):
        ...
        @typing.overload
        def __init__(
            self, FormatRange: PySide2.QtGui.QTextLayout.FormatRange
        ) -> None: ...
        @staticmethod
        def __copy__() -> None: ...
...
class QTextOption(Shiboken.Object):
    ...
    def setTextDirection(
        self, aDirection: PySide2.QtCore.Qt.LayoutDirection
    ) -> None: ...
    def setUseDesignMetrics(self, b: bool) -> None: ...
...
class QTouchDevice(Shiboken.Object):
    ...
    class Capabilities(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, CapabilityFlag, Capabilities] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, CapabilityFlag, Capabilities]
        ) -> Capabilities: ...
        def __and__(
            self, other: typing.Union[int, CapabilityFlag, Capabilities]
        ) -> Capabilities: ...
    ...
    class CapabilityFlag(object):
        ...
        def __rand__(
            self, other: typing.Union[int, CapabilityFlag]
        ) -> Capabilities: ...
        def __rxor__(
            self, other: typing.Union[int, CapabilityFlag]
        ) -> Capabilities: ...
    ...
    def name(self) -> str: ...
    def setCapabilities(
        self, caps: PySide2.QtGui.QTouchDevice.Capabilities
    ) -> None: ...
...
class QTouchEvent(PySide2.QtGui.QInputEvent):
    class TouchPoint(Shiboken.Object):
        ...
        class InfoFlags(object):
            def __index__(self) -> int: ...
            def __init__(
                self, value: typing.Union[int, InfoFlag, InfoFlags] = ...
            ) -> None: ...
            def __or__(
                self, other: typing.Union[int, InfoFlag, InfoFlags]
            ) -> InfoFlags: ...
            def __and__(
                self, other: typing.Union[int, InfoFlag, InfoFlags]
            ) -> InfoFlags: ...
...
class QTransform(Shiboken.Object):
    ...
    @typing.overload
    def __imul__(
        self, arg__1: PySide2.QtGui.QTransform
    ) -> PySide2.QtGui.QTransform: ...
    @typing.overload
...
class QVector2D(Shiboken.Object):
    ...
    @staticmethod
    def dotProduct(
        v1: PySide2.QtGui.QVector2D, v2: PySide2.QtGui.QVector2D
    ) -> float: ...
    def isNull(self) -> bool: ...
    def length(self) -> float: ...
    def lengthSquared(self) -> float: ...
...
class QVector4D(Shiboken.Object):
    ...
    @staticmethod
    def dotProduct(
        v1: PySide2.QtGui.QVector4D, v2: PySide2.QtGui.QVector4D
    ) -> float: ...
    def isNull(self) -> bool: ...
    def length(self) -> float: ...
    def lengthSquared(self) -> float: ...
...
class QWindow(PySide2.QtCore.QObject, PySide2.QtGui.QSurface):
    ...
    @typing.overload
    def parent(
        self, mode: PySide2.QtGui.QWindow.AncestorMode
    ...
    def setCursor(
        self, arg__1: typing.Union[PySide2.QtGui.QCursor, PySide2.QtCore.Qt.CursorShape]
    ) -> None: ...
    ...
    def setSurfaceType(
        self, surfaceType: PySide2.QtGui.QSurface.SurfaceType
    ) -> None: ...
