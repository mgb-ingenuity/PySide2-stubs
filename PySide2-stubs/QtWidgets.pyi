...
class QAbstractItemView(PySide2.QtWidgets.QAbstractScrollArea):
    ...
    class EditTriggers(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, EditTrigger, EditTriggers] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, EditTrigger, EditTriggers]
        ) -> EditTriggers: ...
        def __and__(
            self, other: typing.Union[int, EditTrigger, EditTriggers]
        ) -> EditTriggers: ...
    ...
    def inputMethodQuery(
        self, query: PySide2.QtCore.Qt.InputMethodQuery
    ) -> typing.Any: ...
    ...
    def setDefaultDropAction(
        self, dropAction: PySide2.QtCore.Qt.DropAction
    ) -> None: ...
...
class QAbstractSpinBox(PySide2.QtWidgets.QWidget):
    ...
    class StepEnabled(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, StepEnabledFlag, StepEnabled] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, StepEnabledFlag, StepEnabled]
        ) -> StepEnabled: ...
        def __and__(
            self, other: typing.Union[int, StepEnabledFlag, StepEnabled]
        ) -> StepEnabled: ...
    ...
    class StepEnabledFlag(object):
        ...
        def __rand__(
            self, other: typing.Union[int, StepEnabledFlag]
        ) -> StepEnabled: ...
        def __rxor__(
            self, other: typing.Union[int, StepEnabledFlag]
        ) -> StepEnabled: ...
    ...
    def initStyleOption(
        self, option: PySide2.QtWidgets.QStyleOptionSpinBox
    ) -> None: ...
    def inputMethodQuery(
...
class QAction(PySide2.QtCore.QObject):
    ...
    def setShortcut(
        self, shortcut: typing.Union[PySide2.QtGui.QKeySequence, str]
    ) -> None: ...
    def setShortcutContext(
        self, context: PySide2.QtCore.Qt.ShortcutContext
    ) -> None: ...
...
class QBoxLayout(PySide2.QtWidgets.QLayout):
    ...
    def addLayout(
        self, layout: PySide2.QtWidgets.QLayout, stretch: int = ...
    ) -> None: ...
...
class QColorDialog(PySide2.QtWidgets.QDialog):
    ...
    class ColorDialogOption(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ColorDialogOption] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ColorDialogOption]
        ) -> ColorDialogOptions: ...
        def __and__(
            self, other: typing.Union[int, ColorDialogOption]
        ) -> ColorDialogOptions: ...
    ...
    class ColorDialogOptions(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ColorDialogOption, ColorDialogOptions] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ColorDialogOption, ColorDialogOptions]
        ) -> ColorDialogOptions: ...
        def __and__(
            self, other: typing.Union[int, ColorDialogOption, ColorDialogOptions]
        ) -> ColorDialogOptions: ...
    ...
    def __init__(
        self,
        initial: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
        parent: typing.Optional[PySide2.QtWidgets.QWidget] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
...
class QComboBox(PySide2.QtWidgets.QWidget):
    ...
    def iconSize(self) -> PySide2.QtCore.QSize: ...
    def initStyleOption(
        self, option: PySide2.QtWidgets.QStyleOptionComboBox
    ) -> None: ...
    ...
    def setIconSize(self, size: PySide2.QtCore.QSize) -> None: ...
    def setInsertPolicy(
        self, policy: PySide2.QtWidgets.QComboBox.InsertPolicy
    ) -> None: ...
...
class QCompleter(PySide2.QtCore.QObject):
    ...
    def event(self, arg__1: PySide2.QtCore.QEvent) -> bool: ...
    def eventFilter(
        self, o: PySide2.QtCore.QObject, e: PySide2.QtCore.QEvent
    ) -> bool: ...
...
class QDateTimeEdit(PySide2.QtWidgets.QAbstractSpinBox):
    ...
    class Sections(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, Section, Sections] = ...
        ) -> None: ...
...
class QDialogButtonBox(PySide2.QtWidgets.QWidget):
    ...
    class StandardButton(object):
        ...
        def __init__(
            self, other: typing.Union[QDialogButtonBox.StandardButton, int] = ...
        ...
        def __index__(self) -> int: ...
        def __and__(
            self, other: typing.Union[int, StandardButton]
        ) -> StandardButtons: ...
        def __xor__(
            self, other: typing.Union[int, StandardButton]
        ) -> StandardButtons: ...
    ...
    class StandardButtons(object):
        def __init__(
            self,
            other: typing.Union[
                QDialogButtonBox.StandardButtons, QDialogButtonBox.StandardButton, int
            ] = ...,
        ) -> QDialogButtonBox.StandardButtons: ...
        def __or__(
            self,
        ...
        def __index__(self) -> int: ...
        def __and__(
            self, other: typing.Union[int, StandardButton, StandardButtons]
        ) -> StandardButtons: ...
        def __xor__(
            self, other: typing.Union[int, StandardButton, StandardButtons]
        ) -> StandardButtons: ...
...
class QDirModel(PySide2.QtCore.QAbstractItemModel):
    ...
    def setIconProvider(
        self, provider: PySide2.QtWidgets.QFileIconProvider
    ) -> None: ...
...
class QDockWidget(PySide2.QtWidgets.QWidget):
    ...
    class DockWidgetFeature(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, DockWidgetFeature] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, DockWidgetFeature]
        ) -> DockWidgetFeatures: ...
        def __and__(
            self, other: typing.Union[int, DockWidgetFeature]
        ) -> DockWidgetFeatures: ...
    ...
    class DockWidgetFeatures(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, DockWidgetFeature, DockWidgetFeatures] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, DockWidgetFeature, DockWidgetFeatures]
        ) -> DockWidgetFeatures: ...
        def __and__(
            self, other: typing.Union[int, DockWidgetFeature, DockWidgetFeatures]
        ) -> DockWidgetFeatures: ...
    ...
    def initStyleOption(
        self, option: PySide2.QtWidgets.QStyleOptionDockWidget
    ) -> None: ...
...
class QFileIconProvider(Shiboken.Object):
    ...
    def setOptions(
        self, options: PySide2.QtWidgets.QFileIconProvider.Options
    ) -> None: ...
...
class QFileSystemModel(PySide2.QtCore.QAbstractItemModel):
    ...
    def setOptions(
        self, options: PySide2.QtWidgets.QFileSystemModel.Options
    ) -> None: ...
    def setReadOnly(self, enable: bool) -> None: ...
    def setResolveSymlinks(self, enable: bool) -> None: ...
...
class QFontComboBox(PySide2.QtWidgets.QComboBox):
    ...
    class FontFilters(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, FontFilter, FontFilters] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, FontFilter, FontFilters]
        ) -> FontFilters: ...
        def __and__(
            self, other: typing.Union[int, FontFilter, FontFilters]
        ) -> FontFilters: ...
...
class QFontDialog(PySide2.QtWidgets.QDialog):
    ...
    class FontDialogOption(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, FontDialogOption] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, FontDialogOption]
        ) -> FontDialogOptions: ...
        def __and__(
            self, other: typing.Union[int, FontDialogOption]
        ) -> FontDialogOptions: ...
    ...
    class FontDialogOptions(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, FontDialogOption, FontDialogOptions] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, FontDialogOption, FontDialogOptions]
        ) -> FontDialogOptions: ...
        def __and__(
            self, other: typing.Union[int, FontDialogOption, FontDialogOptions]
        ) -> FontDialogOptions: ...
...
class QGestureEvent(PySide2.QtCore.QEvent):
    ...
    @typing.overload
    def setAccepted(
        self, arg__1: PySide2.QtCore.Qt.GestureType, arg__2: bool
    ) -> None: ...
    @typing.overload
...
class QGestureRecognizer(Shiboken.Object):
    ...
    class Result(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ResultFlag, Result] = ...
        ) -> None: ...
...
class QGraphicsBlurEffect(PySide2.QtWidgets.QGraphicsEffect):
    ...
    class BlurHints(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, BlurHint, BlurHints] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, BlurHint, BlurHints]
        ) -> BlurHints: ...
        def __and__(
            self, other: typing.Union[int, BlurHint, BlurHints]
        ) -> BlurHints: ...
...
class QGraphicsColorizeEffect(PySide2.QtWidgets.QGraphicsEffect):
    ...
    def draw(self, painter: PySide2.QtGui.QPainter) -> None: ...
    def setColor(
        self, c: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int]
    ) -> None: ...
...
class QGraphicsGridLayout(PySide2.QtWidgets.QGraphicsLayout):
    ...
    def setHorizontalSpacing(self, spacing: float) -> None: ...
    def setRowAlignment(
        self, row: int, alignment: PySide2.QtCore.Qt.Alignment
    ) -> None: ...
...
class QGraphicsItem(Shiboken.Object):
    ...
    class GraphicsItemFlag(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, GraphicsItemFlag] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, GraphicsItemFlag]
        ) -> GraphicsItemFlags: ...
        def __and__(
            self, other: typing.Union[int, GraphicsItemFlag]
        ) -> GraphicsItemFlags: ...
    ...
    class GraphicsItemFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, GraphicsItemFlag, GraphicsItemFlags] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, GraphicsItemFlag, GraphicsItemFlags]
        ) -> GraphicsItemFlags: ...
        def __and__(
            self, other: typing.Union[int, GraphicsItemFlag, GraphicsItemFlags]
        ) -> GraphicsItemFlags: ...
    ...
    def scroll(
        self, dx: float, dy: float, rect: PySide2.QtCore.QRectF = ...
    ) -> None: ...
    ...
    def setAcceptedMouseButtons(
        self, buttons: PySide2.QtCore.Qt.MouseButtons
    ) -> None: ...
...
class QGraphicsOpacityEffect(PySide2.QtWidgets.QGraphicsEffect):
    ...
    def setOpacity(self, opacity: float) -> None: ...
    def setOpacityMask(
        self, mask: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor]
    ) -> None: ...
...
class QGraphicsPixmapItem(PySide2.QtWidgets.QGraphicsItem):
    ...
    def setTransformationMode(
        self, mode: PySide2.QtCore.Qt.TransformationMode
    ) -> None: ...
    def shape(self) -> PySide2.QtGui.QPainterPath: ...
...
class QGraphicsProxyWidget(PySide2.QtWidgets.QGraphicsWidget):
    ...
    def resizeEvent(
        self, event: PySide2.QtWidgets.QGraphicsSceneResizeEvent
    ) -> None: ...
    def setGeometry(self, rect: PySide2.QtCore.QRectF) -> None: ...
    def setWidget(self, widget: PySide2.QtWidgets.QWidget) -> None: ...
    def showEvent(self, event: PySide2.QtGui.QShowEvent) -> None: ...
...
class QGraphicsScene(PySide2.QtCore.QObject):
    ...
    class SceneLayers(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, SceneLayer, SceneLayers] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, SceneLayer, SceneLayers]
        ) -> SceneLayers: ...
        def __and__(
            self, other: typing.Union[int, SceneLayer, SceneLayers]
        ) -> SceneLayers: ...
...
class QGraphicsSceneContextMenuEvent(PySide2.QtWidgets.QGraphicsSceneEvent):
    ...
    class Reason(object):
        ...
        Other: QGraphicsSceneContextMenuEvent.Reason = ...  # 0x2
    def __init__(
        self, type: typing.Optional[PySide2.QtCore.QEvent.Type] = ...
    ) -> None: ...
...
class QGraphicsView(PySide2.QtWidgets.QAbstractScrollArea):
    ...
    class CacheMode(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, CacheModeFlag, CacheMode] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, CacheModeFlag, CacheMode]
        ) -> CacheMode: ...
        def __and__(
            self, other: typing.Union[int, CacheModeFlag, CacheMode]
        ) -> CacheMode: ...
    ...
    class OptimizationFlag(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, OptimizationFlag] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, OptimizationFlag]
        ) -> OptimizationFlags: ...
        def __and__(
            self, other: typing.Union[int, OptimizationFlag]
        ) -> OptimizationFlags: ...
    ...
    class OptimizationFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, OptimizationFlag, OptimizationFlags] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, OptimizationFlag, OptimizationFlags]
        ) -> OptimizationFlags: ...
        def __and__(
            self, other: typing.Union[int, OptimizationFlag, OptimizationFlags]
        ) -> OptimizationFlags: ...
    ...
    @typing.overload
    def mapToScene(
        self, polygon: PySide2.QtGui.QPolygon
    ) -> PySide2.QtGui.QPolygonF: ...
    @typing.overload
...
class QGroupBox(PySide2.QtWidgets.QWidget):
    ...
    def focusInEvent(self, event: PySide2.QtGui.QFocusEvent) -> None: ...
    def initStyleOption(
        self, option: PySide2.QtWidgets.QStyleOptionGroupBox
    ) -> None: ...
    def isCheckable(self) -> bool: ...
    def isChecked(self) -> bool: ...
...
class QKeyEventTransition(PySide2.QtCore.QEventTransition):
    ...
    def setModifierMask(
        self, modifiers: PySide2.QtCore.Qt.KeyboardModifiers
    ) -> None: ...
...
class QLabel(PySide2.QtWidgets.QFrame):
    ...
    def setAlignment(
        self,
        arg__1: typing.Union[
            PySide2.QtCore.Qt.Alignment, PySide2.QtCore.Qt.AlignmentFlag
        ],
    ) -> None: ...
...
class QListWidget(PySide2.QtWidgets.QListView):
    ...
    def event(self, e: PySide2.QtCore.QEvent) -> bool: ...
    def findItems(
        self, text: str, flags: PySide2.QtCore.Qt.MatchFlags
    ) -> typing.List: ...
    def indexFromItem(
        self, item: PySide2.QtWidgets.QListWidgetItem
    ) -> PySide2.QtCore.QModelIndex: ...
...
class QMainWindow(PySide2.QtWidgets.QWidget):
    ...
    class DockOptions(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, DockOption, DockOptions] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, DockOption, DockOptions]
        ) -> DockOptions: ...
        def __and__(
            self, other: typing.Union[int, DockOption, DockOptions]
        ) -> DockOptions: ...
...
class QMdiArea(PySide2.QtWidgets.QAbstractScrollArea):
    ...
    class AreaOptions(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, AreaOption, AreaOptions] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, AreaOption, AreaOptions]
        ) -> AreaOptions: ...
        def __and__(
            self, other: typing.Union[int, AreaOption, AreaOptions]
        ) -> AreaOptions: ...
    ...
    def setBackground(
        self, background: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor]
    ) -> None: ...
    def setDocumentMode(self, enabled: bool) -> None: ...
    def setOption(
...
class QMdiSubWindow(PySide2.QtWidgets.QWidget):
    ...
    class SubWindowOption(object):
        ...
        def __or__(
            self, other: typing.Union[int, SubWindowOption]
        ) -> SubWindowOptions: ...
        def __and__(
            self, other: typing.Union[int, SubWindowOption]
        ) -> SubWindowOptions: ...
    ...
    class SubWindowOptions(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, SubWindowOption, SubWindowOptions] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, SubWindowOption, SubWindowOptions]
        ) -> SubWindowOptions: ...
        def __and__(
            self, other: typing.Union[int, SubWindowOption, SubWindowOptions]
        ) -> SubWindowOptions: ...
...
class QMenu(PySide2.QtWidgets.QWidget):
    ...
    def actionGeometry(
        self, arg__1: PySide2.QtWidgets.QAction
    ) -> PySide2.QtCore.QRect: ...
    ...
    @typing.overload
    def addMenu(
        self, icon: PySide2.QtGui.QIcon, title: str
...
class QMessageBox(PySide2.QtWidgets.QDialog):
    ...
    class StandardButton(object):
        ...
        def __init__(
            self, other: typing.Union[QMessageBox.StandardButton, int] = ...
    ...
    class StandardButtons(object):
        def __init__(
            self,
            other: typing.Union[
                QMessageBox.StandardButtons, QMessageBox.StandardButton, int
            ] = ...,
        ) -> QMessageBox.StandardButtons: ...
        def __or__(
            self,
    ...
    @staticmethod
    def about(
        parent: typing.Optional[PySide2.QtWidgets.QWidget], title: str, text: str
    ) -> None: ...
    @staticmethod
    def aboutQt(
        parent: typing.Optional[PySide2.QtWidgets.QWidget], title: str = ...
    ) -> None: ...
    @typing.overload
    def addButton(
        self,
...
class QPlainTextEdit(PySide2.QtWidgets.QAbstractScrollArea):
    ...
    def mergeCurrentCharFormat(
        self, modifier: PySide2.QtGui.QTextCharFormat
    ) -> None: ...
    def mouseDoubleClickEvent(self, e: PySide2.QtGui.QMouseEvent) -> None: ...
    def mouseMoveEvent(self, e: PySide2.QtGui.QMouseEvent) -> None: ...
    def mousePressEvent(self, e: PySide2.QtGui.QMouseEvent) -> None: ...
...
class QProgressDialog(PySide2.QtWidgets.QDialog):
    ...
    def setCancelButton(
        self, button: typing.Optional[PySide2.QtWidgets.QPushButton]
    ) -> None: ...
    def setCancelButtonText(self, text: str) -> None: ...
...
class QProxyStyle(PySide2.QtWidgets.QCommonStyle):
    ...
    @typing.overload
    def __init__(
        self, style: typing.Optional[PySide2.QtWidgets.QStyle] = ...
    ) -> None: ...
...
class QRubberBand(PySide2.QtWidgets.QWidget):
    ...
    def event(self, e: PySide2.QtCore.QEvent) -> bool: ...
    def initStyleOption(
        self, option: PySide2.QtWidgets.QStyleOptionRubberBand
    ) -> None: ...
    @typing.overload
...
class QScrollerProperties(Shiboken.Object):
    ...
    @staticmethod
    def setDefaultScrollerProperties(
        sp: PySide2.QtWidgets.QScrollerProperties,
    ) -> None: ...
    def setScrollMetric(
        self,
...
class QSizePolicy(Shiboken.Object):
    ...
    class ControlTypes(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ControlType, ControlTypes] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ControlType, ControlTypes]
        ) -> ControlTypes: ...
        def __and__(
            self, other: typing.Union[int, ControlType, ControlTypes]
        ) -> ControlTypes: ...
    ...
    def setControlType(
        self, type: PySide2.QtWidgets.QSizePolicy.ControlType
    ) -> None: ...
...
class QSlider(PySide2.QtWidgets.QAbstractSlider):
    ...
    def setTickPosition(
        self, position: PySide2.QtWidgets.QSlider.TickPosition
    ) -> None: ...
    def sizeHint(self) -> PySide2.QtCore.QSize: ...
...
class QStyle(PySide2.QtCore.QObject):
    ...
    class State(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, StateFlag, State] = ...
        ) -> None: ...
    ...
    class SubControls(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, SubControl, SubControls] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, SubControl, SubControls]
        ) -> SubControls: ...
        def __and__(
            self, other: typing.Union[int, SubControl, SubControls]
        ) -> SubControls: ...
...
class QStyleOptionButton(PySide2.QtWidgets.QStyleOption):
    ...
    class ButtonFeature(object):
        ...
        def __and__(
            self, other: typing.Union[int, ButtonFeature]
        ) -> ButtonFeatures: ...
        def __xor__(
            self, other: typing.Union[int, ButtonFeature]
        ) -> ButtonFeatures: ...
    ...
    class ButtonFeatures(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ButtonFeature, ButtonFeatures] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ButtonFeature, ButtonFeatures]
        ) -> ButtonFeatures: ...
        def __and__(
            self, other: typing.Union[int, ButtonFeature, ButtonFeatures]
        ) -> ButtonFeatures: ...
...
class QStyleOptionFrame(PySide2.QtWidgets.QStyleOption):
    ...
    class FrameFeatures(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, FrameFeature, FrameFeatures] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, FrameFeature, FrameFeatures]
        ) -> FrameFeatures: ...
        def __and__(
            self, other: typing.Union[int, FrameFeature, FrameFeatures]
        ) -> FrameFeatures: ...
...
class QStyleOptionGraphicsItem(PySide2.QtWidgets.QStyleOption):
    ...
    def levelOfDetailFromTransform(
        worldTransform: PySide2.QtGui.QTransform,
    ) -> float: ...
...
class QStyleOptionTab(PySide2.QtWidgets.QStyleOption):
    ...
    class CornerWidgets(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, CornerWidget, CornerWidgets] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, CornerWidget, CornerWidgets]
        ) -> CornerWidgets: ...
        def __and__(
            self, other: typing.Union[int, CornerWidget, CornerWidgets]
        ) -> CornerWidgets: ...
    ...
    class TabFeatures(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, TabFeature, TabFeatures] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, TabFeature, TabFeatures]
        ) -> TabFeatures: ...
        def __and__(
            self, other: typing.Union[int, TabFeature, TabFeatures]
        ) -> TabFeatures: ...
...
class QStyleOptionToolBar(PySide2.QtWidgets.QStyleOption):
    ...
    class ToolBarFeature(object):
        ...
        def __or__(
            self, other: typing.Union[int, ToolBarFeature]
        ) -> ToolBarFeatures: ...
        def __and__(
            self, other: typing.Union[int, ToolBarFeature]
        ) -> ToolBarFeatures: ...
    ...
    class ToolBarFeatures(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ToolBarFeature, ToolBarFeatures] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ToolBarFeature, ToolBarFeatures]
        ) -> ToolBarFeatures: ...
        def __and__(
            self, other: typing.Union[int, ToolBarFeature, ToolBarFeatures]
        ) -> ToolBarFeatures: ...
...
class QStyleOptionToolButton(PySide2.QtWidgets.QStyleOptionComplex):
    ...
    class ToolButtonFeature(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ToolButtonFeature] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ToolButtonFeature]
        ) -> ToolButtonFeatures: ...
        def __and__(
            self, other: typing.Union[int, ToolButtonFeature]
        ) -> ToolButtonFeatures: ...
    ...
    class ToolButtonFeatures(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ToolButtonFeature, ToolButtonFeatures] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ToolButtonFeature, ToolButtonFeatures]
        ) -> ToolButtonFeatures: ...
        def __and__(
            self, other: typing.Union[int, ToolButtonFeature, ToolButtonFeatures]
        ) -> ToolButtonFeatures: ...
...
class QStyleOptionViewItem(PySide2.QtWidgets.QStyleOption):
    ...
    class ViewItemFeature(object):
        ...
        def __or__(
            self, other: typing.Union[int, ViewItemFeature]
        ) -> ViewItemFeatures: ...
        def __and__(
            self, other: typing.Union[int, ViewItemFeature]
        ) -> ViewItemFeatures: ...
    ...
    class ViewItemFeatures(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ViewItemFeature, ViewItemFeatures] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ViewItemFeature, ViewItemFeatures]
        ) -> ViewItemFeatures: ...
        def __and__(
            self, other: typing.Union[int, ViewItemFeature, ViewItemFeatures]
        ) -> ViewItemFeatures: ...
...
class QTableWidgetItem(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, icon: PySide2.QtGui.QIcon, text: str, type: int = ...
    ) -> None: ...
    @typing.overload
...
class QTextEdit(PySide2.QtWidgets.QAbstractScrollArea):
    ...
    class AutoFormatting(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, AutoFormattingFlag, AutoFormatting] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, AutoFormattingFlag, AutoFormatting]
        ) -> AutoFormatting: ...
        def __and__(
            self, other: typing.Union[int, AutoFormattingFlag, AutoFormatting]
        ) -> AutoFormatting: ...
    ...
    class AutoFormattingFlag(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, AutoFormattingFlag] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, AutoFormattingFlag]
        ) -> AutoFormatting: ...
        def __and__(
            self, other: typing.Union[int, AutoFormattingFlag]
        ) -> AutoFormatting: ...
    ...
    def setLineWrapMode(
        self, mode: PySide2.QtWidgets.QTextEdit.LineWrapMode
    ) -> None: ...
...
class QToolBar(PySide2.QtWidgets.QWidget):
    ...
    def iconSize(self) -> PySide2.QtCore.QSize: ...
    def initStyleOption(
        self, option: PySide2.QtWidgets.QStyleOptionToolBar
    ) -> None: ...
    def insertSeparator(
        self, before: PySide2.QtWidgets.QAction
    ) -> PySide2.QtWidgets.QAction: ...
...
class QToolButton(PySide2.QtWidgets.QAbstractButton):
    ...
    def hitButton(self, pos: PySide2.QtCore.QPoint) -> bool: ...
    def initStyleOption(
        self, option: PySide2.QtWidgets.QStyleOptionToolButton
    ) -> None: ...
    def leaveEvent(self, arg__1: PySide2.QtCore.QEvent) -> None: ...
    def menu(self) -> PySide2.QtWidgets.QMenu: ...
    def minimumSizeHint(self) -> PySide2.QtCore.QSize: ...
...
class QTreeWidget(PySide2.QtWidgets.QTreeView):
    ...
    def topLevelItem(
        self, index: int
    ) -> typing.Optional[PySide2.QtWidgets.QTreeWidgetItem]: ...
...
class QTreeWidgetItem(Shiboken.Object):
    ...
    def columnCount(self) -> int: ...
    def data(
        self, column: int, role: typing.Union[int, PySide2.QtCore.Qt.ItemDataRole]
    ) -> typing.Any: ...
    ...
    def insertChild(
        self, index: int, child: PySide2.QtWidgets.QTreeWidgetItem
    ) -> None: ...
    ...
    def setBackground(
        self,
        column: int,
        brush: typing.Union[PySide2.QtGui.QColor, PySide2.QtGui.QBrush],
    ) -> None: ...
    def setBackgroundColor(
        self,
        column: int,
    ...
    def setCheckState(
        self, column: int, state: PySide2.QtCore.Qt.CheckState
    ) -> None: ...
    ...
    def setData(
        self,
        column: int,
        role: typing.Union[int, PySide2.QtCore.Qt.ItemDataRole],
        value: typing.Any,
    ) -> None: ...
    ...
    def setForeground(
        self, column: int, brush: Union[PySide2.QtGui.QBrush, PySide2.QtGui.QColor]
    ) -> None: ...
    def setHidden(self, hide: bool) -> None: ...
...
class QWidget(PySide2.QtCore.QObject, PySide2.QtGui.QPaintDevice):
    ...
    @typing.overload
    def grabMouse(
        self, arg__1: Union[PySide2.QtGui.QCursor, PySide2.QtCore.Qt.CursorShape]
    ) -> None: ...
    def grabShortcut(
        self,
        key: PySide2.QtGui.QKeySequence,
    ...
    def setAttribute(
        self, arg__1: PySide2.QtCore.Qt.WidgetAttribute, on: bool = ...
    ) -> None: ...
    def setAutoFillBackground(self, enabled: bool) -> None: ...
    ...
    def setWindowFlag(
        self, arg__1: PySide2.QtCore.Qt.WindowType, on: bool = ...
    ) -> None: ...
...
class QWizard(PySide2.QtWidgets.QDialog):
    ...
    class WizardOptions(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, WizardOption, WizardOptions] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, WizardOption, WizardOptions]
        ) -> WizardOptions: ...
        def __and__(
            self, other: typing.Union[int, WizardOption, WizardOptions]
        ) -> WizardOptions: ...
