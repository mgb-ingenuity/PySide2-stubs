...
class QtDataVisualization(Shiboken.Object):
    ...
    class QAbstract3DGraph(PySide2.QtGui.QWindow):
        ...
        class OptimizationHint(object):
            ...
            def __init__(
                self, value: typing.Union[int, OptimizationHint] = ...
            ) -> None: ...
            def __or__(
                self, other: typing.Union[int, OptimizationHint]
            ) -> OptimizationHints: ...
            def __and__(
                self, other: typing.Union[int, OptimizationHint]
            ) -> OptimizationHints: ...
        ...
        class OptimizationHints(object):
            ...
            def __init__(
                self,
                value: typing.Union[int, OptimizationHint, OptimizationHints] = ...,
            ) -> None: ...
            def __or__(
                self, other: typing.Union[int, OptimizationHint, OptimizationHints]
            ) -> OptimizationHints: ...
            def __and__(
                self, other: typing.Union[int, OptimizationHint, OptimizationHints]
            ) -> OptimizationHints: ...
        ...
        class SelectionFlag(object):
            ...
            def __index__(self) -> int: ...
            def __init__(
                self, value: typing.Union[int, SelectionFlag] = ...
            ) -> None: ...
            def __or__(
    ...
    class QItemModelBarDataProxy(PySide2.QtDataVisualization.QBarDataProxy):
        ...
        def setItemModel(
            self, itemModel: PySide2.QtCore.QAbstractItemModel
        ) -> None: ...
    ...
    class QSurface3DSeries(PySide2.QtDataVisualization.QAbstract3DSeries):
        ...
        class DrawFlags(object):
            def __index__(self) -> int: ...
            def __init__(
                self, value: typing.Union[int, DrawFlag, DrawFlags] = ...
            ) -> None: ...
            def __or__(
                self, other: typing.Union[int, DrawFlag, DrawFlags]
            ) -> DrawFlags: ...
            def __and__(
                self, other: typing.Union[int, DrawFlag, DrawFlags]
            ) -> DrawFlags: ...
