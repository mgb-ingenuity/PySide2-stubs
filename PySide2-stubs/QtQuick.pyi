...
class QQuickFramebufferObject(PySide2.QtQuick.QQuickItem):
    ...
    class Renderer(Shiboken.Object):
        ...
        def synchronize(
            self, arg__1: PySide2.QtQuick.QQuickFramebufferObject
        ) -> None: ...
...
class QQuickItem(PySide2.QtCore.QObject, PySide2.QtQml.QQmlParserStatus):
    ...
    def setCursor(
        self, cursor: typing.Union[PySide2.QtGui.QCursor, PySide2.QtCore.Qt.CursorShape]
    ) -> None: ...
...
class QQuickPaintedItem(PySide2.QtQuick.QQuickItem):
    ...
    class PerformanceHint(object):
        ...
        def __or__(
            self, other: typing.Union[int, PerformanceHint]
        ) -> PerformanceHints: ...
        def __and__(
            self, other: typing.Union[int, PerformanceHint]
        ) -> PerformanceHints: ...
    ...
    class PerformanceHints(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, PerformanceHint, PerformanceHints] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, PerformanceHint, PerformanceHints]
        ) -> PerformanceHints: ...
        def __and__(
            self, other: typing.Union[int, PerformanceHint, PerformanceHints]
        ) -> PerformanceHints: ...
    ...
    def setFillColor(
        self,
        arg__1: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
    ) -> None: ...
...
class QQuickWindow(PySide2.QtGui.QWindow):
    ...
    class CreateTextureOption(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, CreateTextureOption] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, CreateTextureOption]
    ...
    class CreateTextureOptions(object):
        ...
        def __init__(
            self,
            value: typing.Union[int, CreateTextureOption, CreateTextureOptions] = ...,
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, CreateTextureOption, CreateTextureOptions]
        ) -> CreateTextureOptions: ...
        def __and__(
            self, other: typing.Union[int, CreateTextureOption, CreateTextureOptions]
        ) -> CreateTextureOptions: ...
...
class QSGAbstractRenderer(PySide2.QtCore.QObject):
    ...
    class ClearMode(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ClearModeBit, ClearMode] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ClearModeBit, ClearMode]
        ) -> ClearMode: ...
        def __and__(
            self, other: typing.Union[int, ClearModeBit, ClearMode]
        ) -> ClearMode: ...
    ...
    class MatrixTransformFlag(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, MatrixTransformFlag] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, MatrixTransformFlag]
    ...
    class MatrixTransformFlags(object):
        ...
        def __init__(
            self,
            value: typing.Union[int, MatrixTransformFlag, MatrixTransformFlags] = ...,
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, MatrixTransformFlag, MatrixTransformFlags]
        ) -> MatrixTransformFlags: ...
        def __and__(
            self, other: typing.Union[int, MatrixTransformFlag, MatrixTransformFlags]
        ) -> MatrixTransformFlags: ...
    ...
    def setClearMode(
        self, mode: PySide2.QtQuick.QSGAbstractRenderer.ClearMode
    ) -> None: ...
    @typing.overload
...
class QSGGeometry(Shiboken.Object):
    ...
    class Attribute(Shiboken.Object):
        ...
        @typing.overload
        def __init__(
            self, Attribute: PySide2.QtQuick.QSGGeometry.Attribute
        ) -> None: ...
        @staticmethod
        def __copy__() -> None: ...
        @staticmethod
    ...
    def setIndexDataPattern(
        self, p: PySide2.QtQuick.QSGGeometry.DataPattern
    ) -> None: ...
    def setLineWidth(self, w: float) -> None: ...
    def setVertexDataPattern(
        self, p: PySide2.QtQuick.QSGGeometry.DataPattern
    ) -> None: ...
...
class QSGNode(Shiboken.Object):
    ...
    class DirtyState(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, DirtyStateBit, DirtyState] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, DirtyStateBit, DirtyState]
        ) -> DirtyState: ...
        def __and__(
            self, other: typing.Union[int, DirtyStateBit, DirtyState]
        ) -> DirtyState: ...
    ...
    def setFlag(
        self, arg__1: PySide2.QtQuick.QSGNode.Flag, arg__2: bool = ...
    ) -> None: ...
    def setFlags(
...
class QSGSimpleTextureNode(PySide2.QtQuick.QSGGeometryNode):
    ...
    class TextureCoordinatesTransformFlag(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, TextureCoordinatesTransformFlag] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, TextureCoordinatesTransformFlag]
    ...
    class TextureCoordinatesTransformMode(object):
        ...
        def __init__(
            self,
            value: typing.Union[
                int, TextureCoordinatesTransformFlag, TextureCoordinatesTransformMode
            ] = ...,
        ) -> None: ...
        def __or__(
            self,
...
class QSGTexture(PySide2.QtCore.QObject):
    ...
    def setHorizontalWrapMode(
        self, hwrap: PySide2.QtQuick.QSGTexture.WrapMode
    ) -> None: ...
    def setMipmapFiltering(
        self, filter: PySide2.QtQuick.QSGTexture.Filtering
    ) -> None: ...
    def setVerticalWrapMode(
        self, vwrap: PySide2.QtQuick.QSGTexture.WrapMode
    ) -> None: ...
