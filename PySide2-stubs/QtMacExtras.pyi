...
class QMacPasteboardMime(Shiboken.Object):
    ...
    def convertFromMime(
        self, mime: str, data: typing.Any, flav: str
    ) -> typing.List: ...
    def convertToMime(
        self, mime: str, data: typing.Sequence, flav: str
    ) -> typing.Any: ...
...
class QMacToolBar(PySide2.QtCore.QObject):
    @typing.overload
    def __init__(
        self, identifier: str, parent: typing.Optional[PySide2.QtCore.QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
    ...
    ) -> PySide2.QtMacExtras.QMacToolBarItem: ...
    def addAllowedStandardItem(
        self, standardItem: PySide2.QtMacExtras.QMacToolBarItem.StandardItem
    ) -> PySide2.QtMacExtras.QMacToolBarItem: ...
    def addItem(
        self, icon: PySide2.QtGui.QIcon, text: str
    ) -> PySide2.QtMacExtras.QMacToolBarItem: ...
