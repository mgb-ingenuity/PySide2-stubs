...
class QSql(Shiboken.Object):
    ...
    class ParamType(object):
        ...
        def __init__(
            self, value: typing.Union[int, ParamTypeFlag, ParamType] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ParamTypeFlag, ParamType]
        ) -> ParamType: ...
        def __and__(
            self, other: typing.Union[int, ParamTypeFlag, ParamType]
        ) -> ParamType: ...
...
class QSqlDatabase(Shiboken.Object):
    ...
    def numericalPrecisionPolicy(
        self,
    ) -> PySide2.QtSql.QSql.NumericalPrecisionPolicy: ...
    @typing.overload
    def open(self) -> bool: ...
    @typing.overload
...
class QSqlField(Shiboken.Object):
    ...
    def setRequiredStatus(
        self, status: PySide2.QtSql.QSqlField.RequiredStatus
    ) -> None: ...
...
class QSqlQuery(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, query: str = ..., db: PySide2.QtSql.QSqlDatabase = ...
    ) -> None: ...
    @typing.overload
    ...
    def driver(self) -> PySide2.QtSql.QSqlDriver: ...
    def execBatch(
        self, mode: PySide2.QtSql.QSqlQuery.BatchExecutionMode = ...
    ) -> bool: ...
    @typing.overload
    def exec_(self) -> bool: ...
    @typing.overload
...
class QSqlRelationalDelegate(PySide2.QtWidgets.QItemDelegate):
    def __init__(
        self, aParent: typing.Optional[PySide2.QtCore.QObject] = ...
    ) -> None: ...
    def createEditor(
        self,
...
class QSqlRelationalTableModel(PySide2.QtSql.QSqlTableModel):
    ...
    def setRelation(
        self, column: int, relation: PySide2.QtSql.QSqlRelation
    ) -> None: ...
