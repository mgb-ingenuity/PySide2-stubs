...
class Qt3DExtras(Shiboken.Object):
    ...
    class QGoochMaterial(PySide2.Qt3DRender.QMaterial):
        ...
        def setCool(
            self,
            cool: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
        ) -> None: ...
        def setDiffuse(
            self,
            diffuse: Union[
        ...
        def setWarm(
            self,
            warm: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int],
        ) -> None: ...
        def shininess(self) -> float: ...
        def specular(self) -> PySide2.QtGui.QColor: ...
