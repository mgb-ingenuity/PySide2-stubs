...
class QAbstractVideoSurface(PySide2.QtCore.QObject):
    ...
    def setError(
        self, error: PySide2.QtMultimedia.QAbstractVideoSurface.Error
    ) -> None: ...
...
class QAudioFormat(Shiboken.Object):
    ...
    def setByteOrder(
        self, byteOrder: PySide2.QtMultimedia.QAudioFormat.Endian
    ) -> None: ...
...
class QCamera(PySide2.QtMultimedia.QMediaObject):
    ...
    class CaptureModes(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, CaptureMode, CaptureModes] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, CaptureMode, CaptureModes]
        ) -> CaptureModes: ...
        def __and__(
            self, other: typing.Union[int, CaptureMode, CaptureModes]
        ) -> CaptureModes: ...
    ...
    class LockTypes(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, LockType, LockTypes] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, LockType, LockTypes]
        ) -> LockTypes: ...
        def __and__(
            self, other: typing.Union[int, LockType, LockTypes]
        ) -> LockTypes: ...
...
class QCameraControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def setCaptureMode(
        self, arg__1: PySide2.QtMultimedia.QCamera.CaptureModes
    ) -> None: ...
...
class QCameraExposure(PySide2.QtCore.QObject):
    ...
    class FlashModes(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, FlashMode, FlashModes] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, FlashMode, FlashModes]
        ) -> FlashModes: ...
        def __and__(
            self, other: typing.Union[int, FlashMode, FlashModes]
        ) -> FlashModes: ...
...
class QCameraFocus(PySide2.QtCore.QObject):
    ...
    class FocusModes(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, FocusMode, FocusModes] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, FocusMode, FocusModes]
        ) -> FocusModes: ...
        def __and__(
            self, other: typing.Union[int, FocusMode, FocusModes]
        ) -> FocusModes: ...
...
class QCameraImageCapture(
    ...
    class CaptureDestination(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, CaptureDestination] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, CaptureDestination]
        ) -> CaptureDestinations: ...
        def __and__(
            self, other: typing.Union[int, CaptureDestination]
        ) -> CaptureDestinations: ...
    ...
    class CaptureDestinations(object):
        ...
        def __init__(
            self,
            value: typing.Union[int, CaptureDestination, CaptureDestinations] = ...,
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, CaptureDestination, CaptureDestinations]
        ) -> CaptureDestinations: ...
        def __and__(
            self, other: typing.Union[int, CaptureDestination, CaptureDestinations]
        ) -> CaptureDestinations: ...
...
class QCameraViewfinderSettings(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, other: PySide2.QtMultimedia.QCameraViewfinderSettings
    ) -> None: ...
    @staticmethod
    def __copy__() -> None: ...
    def isNull(self) -> bool: ...
...
class QMediaContent(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, contentResource: PySide2.QtMultimedia.QMediaResource
    ) -> None: ...
    @typing.overload
...
class QMediaPlayer(PySide2.QtMultimedia.QMediaObject):
    ...
    def currentNetworkConfiguration(
        self,
    ...
    @typing.overload
    def setVideoOutput(
        self, arg__1: PySide2.QtMultimediaWidgets.QVideoWidget
    ) -> None: ...
    @typing.overload
    def setVideoOutput(
        self, surface: PySide2.QtMultimedia.QAbstractVideoSurface
...
class QMediaServiceProviderHint(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, other: PySide2.QtMultimedia.QMediaServiceProviderHint
    ) -> None: ...
    @typing.overload
...
class QMediaTimeRange(Shiboken.Object):
    ...
    @typing.overload
    def addInterval(
        self, interval: PySide2.QtMultimedia.QMediaTimeInterval
    ) -> None: ...
    @typing.overload
...
class QRadioTuner(PySide2.QtMultimedia.QMediaObject):
    ...
    def setMuted(self, muted: bool) -> None: ...
    def setStereoMode(
        self, mode: PySide2.QtMultimedia.QRadioTuner.StereoMode
    ) -> None: ...
    def setVolume(self, volume: int) -> None: ...
...
class QRadioTunerControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def frequency(self) -> int: ...
    def frequencyRange(
        self, b: PySide2.QtMultimedia.QRadioTuner.Band
    ) -> typing.Tuple: ...
...
class QVideoFilterRunnable(Shiboken.Object):
    ...
    class RunFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, RunFlag, RunFlags] = ...
        ) -> None: ...
...
class QVideoFrame(Shiboken.Object):
    ...
    def setFieldType(
        self, arg__1: PySide2.QtMultimedia.QVideoFrame.FieldType
    ) -> None: ...
    def setMetaData(self, key: str, value: typing.Any) -> None: ...
