...
class QWinJumpList(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def addCategory(
        self, category: PySide2.QtWinExtras.QWinJumpListCategory
    ) -> None: ...
    @typing.overload
    def addCategory(
...
class QWinThumbnailToolBar(PySide2.QtCore.QObject):
    ...
    def addButton(
        self, button: PySide2.QtWinExtras.QWinThumbnailToolButton
    ) -> None: ...
...
class QtWin(Shiboken.Object):
    ...
    def setWindowDisallowPeek(
        window: PySide2.QtGui.QWindow, disallow: bool
    ) -> None: ...
    @typing.overload
    @staticmethod
    def setWindowDisallowPeek(
    ...
    def setWindowExcludedFromPeek(
        window: PySide2.QtGui.QWindow, exclude: bool
    ) -> None: ...
    @typing.overload
    @staticmethod
    def setWindowExcludedFromPeek(
