...
class QAbstractSocket(PySide2.QtCore.QIODevice):
    ...
    class BindMode(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, BindFlag, BindMode] = ...
        ) -> None: ...
        ...
        def __rand__(
            self, other: typing.Union[int, BindFlag, BindMode]
        ) -> BindMode: ...
        def __rxor__(
            self, other: typing.Union[int, BindFlag, BindMode]
        ) -> BindMode: ...
    ...
    class PauseModes(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, PauseMode, PauseModes] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, PauseMode, PauseModes]
        ) -> PauseModes: ...
        def __and__(
            self, other: typing.Union[int, PauseMode, PauseModes]
        ) -> PauseModes: ...
...
class QHostAddress(Shiboken.Object):
    ...
    class ConversionMode(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ConversionModeFlag, ConversionMode] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ConversionModeFlag, ConversionMode]
        ) -> ConversionMode: ...
        def __and__(
            self, other: typing.Union[int, ConversionModeFlag, ConversionMode]
        ) -> ConversionMode: ...
    ...
    class ConversionModeFlag(object):
        ...
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, ConversionModeFlag] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, ConversionModeFlag]
        ) -> ConversionMode: ...
        def __and__(
            self, other: typing.Union[int, ConversionModeFlag]
        ) -> ConversionMode: ...
    ...
    @typing.overload
    def isInSubnet(
        self, subnet: PySide2.QtNetwork.QHostAddress, netmask: int
    ) -> bool: ...
    @typing.overload
...
class QHstsPolicy(Shiboken.Object):
    ...
    class PolicyFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, PolicyFlag, PolicyFlags] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, PolicyFlag, PolicyFlags]
        ) -> PolicyFlags: ...
        def __and__(
            self, other: typing.Union[int, PolicyFlag, PolicyFlags]
        ) -> PolicyFlags: ...
...
class QLocalServer(PySide2.QtCore.QObject):
    ...
    class SocketOptions(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, SocketOption, SocketOptions] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, SocketOption, SocketOptions]
        ) -> SocketOptions: ...
        def __and__(
            self, other: typing.Union[int, SocketOption, SocketOptions]
        ) -> SocketOptions: ...
...
class QNetworkAccessManager(PySide2.QtCore.QObject):
    ...
    def setProxyFactory(
        self, factory: PySide2.QtNetwork.QNetworkProxyFactory
    ) -> None: ...
...
class QNetworkConfiguration(Shiboken.Object):
    ...
    class StateFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, StateFlag, StateFlags] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, StateFlag, StateFlags]
        ) -> StateFlags: ...
        def __and__(
            self, other: typing.Union[int, StateFlag, StateFlags]
        ) -> StateFlags: ...
...
class QNetworkConfigurationManager(PySide2.QtCore.QObject):
    ...
    class Capabilities(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, Capability, Capabilities] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, Capability, Capabilities]
        ) -> Capabilities: ...
        def __and__(
            self, other: typing.Union[int, Capability, Capabilities]
        ) -> Capabilities: ...
...
class QNetworkInterface(Shiboken.Object):
    ...
    class InterfaceFlag(object):
        ...
        def __and__(
            self, other: typing.Union[int, InterfaceFlag]
        ) -> InterfaceFlags: ...
        def __xor__(
            self, other: typing.Union[int, InterfaceFlag]
        ) -> InterfaceFlags: ...
    ...
    class InterfaceFlags(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, InterfaceFlag, InterfaceFlags] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, InterfaceFlag, InterfaceFlags]
        ) -> InterfaceFlags: ...
        def __and__(
            self, other: typing.Union[int, InterfaceFlag, InterfaceFlags]
        ) -> InterfaceFlags: ...
...
class QNetworkRequest(Shiboken.Object):
    ...
    def setPriority(
        self, priority: PySide2.QtNetwork.QNetworkRequest.Priority
    ) -> None: ...
    def setRawHeader(
        self, headerName: PySide2.QtCore.QByteArray, value: PySide2.QtCore.QByteArray
    ) -> None: ...
...
class QNetworkSession(PySide2.QtCore.QObject):
    ...
    class UsagePolicies(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, UsagePolicy, UsagePolicies] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, UsagePolicy, UsagePolicies]
        ) -> UsagePolicies: ...
        def __and__(
            self, other: typing.Union[int, UsagePolicy, UsagePolicies]
        ) -> UsagePolicies: ...
...
class QSsl(Shiboken.Object):
    ...
    class SslOptions(object):
        def __index__(self) -> int: ...
        def __init__(
            self, value: typing.Union[int, SslOption, SslOptions] = ...
        ) -> None: ...
        def __or__(
            self, other: typing.Union[int, SslOption, SslOptions]
        ) -> SslOptions: ...
        def __and__(
            self, other: typing.Union[int, SslOption, SslOptions]
        ) -> SslOptions: ...
...
class QSslCertificate(Shiboken.Object):
    ...
    @staticmethod
    def verify(
        certificateChain: typing.Sequence, hostName: str = ...
    ) -> typing.List: ...
...
class QSslCipher(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, name: str, protocol: PySide2.QtNetwork.QSsl.SslProtocol
    ) -> None: ...
    @typing.overload
...
class QSslConfiguration(Shiboken.Object):
    ...
    def setBackendConfiguration(
        self, backendConfiguration: typing.Dict = ...
    ) -> None: ...
    ...
    def setSslOption(
        self, option: PySide2.QtNetwork.QSsl.SslOption, on: bool
    ) -> None: ...
    @staticmethod
...
class QSslDiffieHellmanParameters(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, other: PySide2.QtNetwork.QSslDiffieHellmanParameters
    ) -> None: ...
    @staticmethod
    def __copy__() -> None: ...
    @staticmethod
...
class QSslKey(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, handle: int, type: PySide2.QtNetwork.QSsl.KeyType = ...
    ) -> None: ...
    @typing.overload
...
class QSslSocket(PySide2.QtNetwork.QTcpSocket):
    ...
    def setSslConfiguration(
        self, config: PySide2.QtNetwork.QSslConfiguration
    ) -> None: ...
    def socketOption(
        self, option: PySide2.QtNetwork.QAbstractSocket.SocketOption
    ) -> typing.Any: ...
...
class QUdpSocket(PySide2.QtNetwork.QAbstractSocket):
    ...
    def joinMulticastGroup(
        self, groupAddress: PySide2.QtNetwork.QHostAddress
    ) -> bool: ...
    @typing.overload
    def joinMulticastGroup(
        self,
    ...
    def setMulticastInterface(
        self, iface: PySide2.QtNetwork.QNetworkInterface
    ) -> None: ...
    @typing.overload
    def writeDatagram(
        self,
