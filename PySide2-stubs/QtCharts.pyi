...
class QtCharts(Shiboken.Object):
    ...
    class QAbstractBarSeries(PySide2.QtCharts.QAbstractSeries):
        ...
        def count(self) -> int: ...
        def insert(
            self, index: int, set: PySide2.QtCharts.QtCharts.QBarSet
        ) -> bool: ...
    ...
    class QAreaSeries(PySide2.QtCharts.QAbstractSeries):
        ...
        def setLowerSeries(
            self, series: PySide2.QtCharts.QtCharts.QLineSeries
        ) -> None: ...
    ...
    class QBoxPlotModelMapper(PySide2.QtCore.QObject):
        ...
        def setSeries(
            self, series: PySide2.QtCharts.QtCharts.QBoxPlotSeries
        ) -> None: ...
    ...
    class QBoxPlotSeries(PySide2.QtCharts.QAbstractSeries):
        ...
        def count(self) -> int: ...
        def insert(
            self, index: int, box: PySide2.QtCharts.QtCharts.QBoxSet
        ) -> bool: ...
        def pen(self) -> PySide2.QtGui.QPen: ...
    ...
    class QChart(PySide2.QtWidgets.QGraphicsWidget):
        ...
        class AnimationOption(object):
            ...
            def __init__(
                self, value: typing.Union[int, AnimationOption] = ...
            ) -> None: ...
            def __or__(
                self, other: typing.Union[int, AnimationOption]
            ) -> AnimationOptions: ...
            def __and__(
                self, other: typing.Union[int, AnimationOption]
            ) -> AnimationOptions: ...
        ...
        class AnimationOptions(object):
            def __index__(self) -> int: ...
            def __init__(
                self, value: typing.Union[int, AnimationOption, AnimationOptions] = ...
            ) -> None: ...
            def __or__(
                self, other: typing.Union[int, AnimationOption, AnimationOptions]
            ) -> AnimationOptions: ...
            def __and__(
                self, other: typing.Union[int, AnimationOption, AnimationOptions]
            ) -> AnimationOptions: ...
        ...
        def setAnimationEasingCurve(
            self, curve: PySide2.QtCore.QEasingCurve
        ) -> None: ...
        ...
        def setTheme(
            self, theme: PySide2.QtCharts.QtCharts.QChart.ChartTheme
        ) -> None: ...
    ...
    class QChartView(PySide2.QtWidgets.QGraphicsView):
        ...
        class RubberBands(object):
            def __index__(self) -> int: ...
            def __init__(
                self, value: typing.Union[int, RubberBand, RubberBands] = ...
            ) -> None: ...
            def __or__(
                self, other: typing.Union[int, RubberBand, RubberBands]
            ) -> RubberBands: ...
            def __and__(
                self, other: typing.Union[int, RubberBand, RubberBands]
            ) -> RubberBands: ...
    ...
    class QPolarChart(PySide2.QtCharts.QChart):
        ...
        class PolarOrientation(object):
            ...
            def __index__(self) -> int: ...
            def __init__(
                self, value: typing.Union[int, PolarOrientation] = ...
            ) -> None: ...
            def __or__(
                self, other: typing.Union[int, PolarOrientation]
            ) -> PolarOrientations: ...
            def __and__(
                self, other: typing.Union[int, PolarOrientation]
            ) -> PolarOrientations: ...
        ...
        class PolarOrientations(object):
            ...
            def __init__(
                self,
                value: typing.Union[int, PolarOrientation, PolarOrientations] = ...,
            ) -> None: ...
            def __or__(
                self, other: typing.Union[int, PolarOrientation, PolarOrientations]
            ) -> PolarOrientations: ...
            def __and__(
                self, other: typing.Union[int, PolarOrientation, PolarOrientations]
            ) -> PolarOrientations: ...
