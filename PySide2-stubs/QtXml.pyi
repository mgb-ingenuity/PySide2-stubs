...
class QDomNamedNodeMap(Shiboken.Object):
    ...
    def setNamedItem(
        self, newNode: PySide2.QtXml.QDomNode
    ) -> PySide2.QtXml.QDomNode: ...
    def setNamedItemNS(
        self, newNode: PySide2.QtXml.QDomNode
    ) -> PySide2.QtXml.QDomNode: ...
...
class QDomNode(Shiboken.Object):
    ...
    def appendChild(
        self, newChild: PySide2.QtXml.QDomNode
    ) -> PySide2.QtXml.QDomNode: ...
    def attributes(self) -> PySide2.QtXml.QDomNamedNodeMap: ...
    ...
    def removeChild(
        self, oldChild: PySide2.QtXml.QDomNode
    ) -> PySide2.QtXml.QDomNode: ...
    def replaceChild(
...
class QXmlNamespaceSupport(Shiboken.Object):
    ...
    def processName(
        self, arg__1: str, arg__2: bool, arg__3: str, arg__4: str
    ) -> None: ...
...
class QXmlSimpleReader(PySide2.QtXml.QXmlReader):
    ...
    @typing.overload
    def parse(
        self, input: PySide2.QtXml.QXmlInputSource, incremental: bool
    ) -> bool: ...
