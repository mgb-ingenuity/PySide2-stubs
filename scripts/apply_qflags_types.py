...
def auto_test():
    assert (
        fqn_names_match(
            "PySide2.QtCore.QAbstractModel", "PySide2.QtCore.QAbstractModel", "QtCore"
        )
        == True
    )
    assert (
        fqn_names_match(
            "PySide2.QtCore.QAbstractModel", "QtCore.QAbstractModel", "QtCore"
        )
        == True
    )
    assert (
        fqn_names_match("PySide2.QtCore.QAbstractModel", "QAbstractModel", "QtCore")
        == True
    )
    assert (
        fqn_names_match("PySide2.QtCore.QAbstractModel", "QAbstractModel", "QtGui")
        == False
    )
    assert (
        fqn_names_match(
            "PySide2.QtCore.QAbstractModel", "QtGui.QAbstractModel", "QtGui"
        )
        == False
    )
...
class TypingTransformer(cst.CSTTransformer):
    ...
    def leave_AnnAssign(
        ...
        declared_type = cst.helpers.get_full_name_for_node(
